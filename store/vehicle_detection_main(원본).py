...
def object_detection_function():
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            cap = cv2.VideoCapture('comart_5fps_0710.avi')
            while cap.isOpened():
                (ret, frame) = cap.read()
                ...
                if ret == True:
                    ...
                    cv2.putText(input_frame,'Detected Vehicles: ' + str(total_passed_vehicle), (10, 35), font, 0.8, (0, 0xFF, 0xFF), 2, cv2.FONT_HERSHEY_SIMPLEX)
